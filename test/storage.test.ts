...
describe('Database / GroupConfigRepository', () => {
  ...
  it('incrementPunishments adds 1 to punishmentsToday', () => {
    const cfg = {
      ...
      kickConfirmModel: 'claude-opus-4-6' as const,
      chatLoreEnabled: true, nameImagesEnabled: true,
      nameImagesCollectionTimeoutMs: 120_000, nameImagesCollectionMax: 20,
      nameImagesCooldownMs: 300_000, nameImagesMaxPerName: 50,
      chatAtMentionQueueMax: 5, chatAtMentionBurstWindowMs: 30_000, chatAtMentionBurstThreshold: 3,
      repeaterEnabled: true, repeaterMinCount: 3, repeaterCooldownMs: 600_000,
      repeaterMinContentLength: 2, repeaterMaxContentLength: 100,
      nameImagesBlocklist: [], loreUpdateEnabled: true, loreUpdateThreshold: 200, loreUpdateCooldownMs: 1_800_000,
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    };
    db.groupConfig.upsert(cfg);
